...
export const Accounts = ({ id, number, balance, creationDate }) => {
  ...
  return (
    ...
    <div key={id} className='flex flex-col w-full text-white gap-1 pb-3'>
            <h2 className='font-bold flex movil:flex-row movil:flex-wrap movil:justify-center tablet:justify-between movil:pb-5 w-full text-xl'>Account N°:  {number} <p className='laptop:creationDate movil:text-lg laptop:text-xl movil:text-center'>Creation date: {creationDate}</p></h2>
