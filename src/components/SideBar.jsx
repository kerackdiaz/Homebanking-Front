...
<div className="rounded-r bg-gray-900 xl:hidden flex justify-between w-full p-6 items-center">
  <div className="flex justify-between items-center space-x-3">
    ...
    <h1 className="text-2xl leading-6 font-space-grotesk text-white">Ulver</h1>
  </div>
  <div aria-label="toggler" className="flex justify-center items-center">
    <button aria-label="open" id="open"  className='focus:outline-none focus:ring-2'>
...
<div id="SideBar" className=" transform sticky top-0 xl:translate-x-0  ease-in-out transition duration-500 flex justify-start items-start h-screen w-full sm:w-[15%] bg-[#0e0f11] flex-col">

  <div className="hidden xl:flex justify-start p-6 items-center space-x-3">
    <img className="w-12 invert" src={Logo} alt="" />
    <p className="text-2xl leading-6 text-white">Ulver</p>
  </div>
  <div className="mt-6 flex flex-col justify-start items-start  pl-4 w-full border-gray-600 border-b space-y-3 pb-5 ">
  ...
  <div className="flex flex-col justify-start items-center pb-4  px-6 border-b border-gray-600 w-full  ">
    <span  className="focus:outline-none focus:text-indigo-400 text-left  text-white flex justify-between items-center w-full py-5 space-x-14  ">
      <p className="text-sm leading-5  uppercase">My Products</p>
    </span>
      <Link to="/account" className="flex justify-start items-center space-x-6 hover:text-white focus:bg-gray-700 focus:text-white hover:bg-gray-700 text-gray-400 rounded px-3 py-2  w-full md:w-52">
        ...
        <p className="text-base leading-4  ">My Account</p>
      </Link>
      ...
      <img className='w-5 invert' src={CardIcon} alt="" />
        <p className="text-base leading-4  ">My Cards</p>
      </Link>
      ...
      <img className='w-6 invert' src={LoanIcon} alt="" />
        <p className="text-base leading-4  ">My Loans</p>
      </Link>
      ...
      <img className='w-6 invert' src={TransactionIcon} alt="" />
        <p className="text-base leading-4  ">Transfers</p>
      </Link>
  ...
  <div className="flex flex-col items-center h-full pb-6   px-6  w-full  space-y-3 ">
