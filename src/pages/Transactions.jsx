...
const Transactions = () => {
  ...
  return (
<div id="MyTransactions" className='bg-[#15151d] movil:w-screen laptop:w-[85%] movil:min-h-[100vh] laptop:min-h-screen pb-20 flex movil:flex-col content-start flex-wrap'>
